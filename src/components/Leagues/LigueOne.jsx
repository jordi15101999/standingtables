...
const LigueOne = () => {
  ...
  const getTable = async () => {
    const response = await fetch(
      "https://livescore-api.com/api-client/competitions/standings.json?competition_id=5&key=Rqy9nSLFDFYJfeES&secret=oVkGVGMdllZw0qaRRI1eAMUdrTXH7Bzw"
    );
  ...
  return (
    <div className="tables">
      ...
      <Container>
        <Table striped hover responsive variant="dark" className="">
          <thead>
            <tr>
              <th>Rank</th>
              <th>Club</th>
