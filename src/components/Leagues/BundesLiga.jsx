...
const BundesLiga = () => {
  ...
  //     "https://livescore-api.com/api-client/competitions/standings.json?competition_id=1&key=Rqy9nSLFDFYJfeES&secret=oVkGVGMdllZw0qaRRI1eAMUdrTXH7Bzw"
  //   );
  ...
  return (
    <div className="tables">
      ...
      <Container>
        <Table striped hover responsive variant="danger">
        ...
        {/* <Table striped hover responsive variant="danger" className="">
          <thead>
            <tr>
              <th>Rank</th>
              <th>Club</th>
